    ...
    def detect_invasibility(self,t_start,extinct_thresh=1e-4):
        ...
        How the function works: 
            ...
            (2) Detect whether extant species have "fluctuating" dynamics using scipy's 
                find_peaks function. This will...
            (3) (a) If no species have fluctuating dynamics, invasibility is set 
                    to 0 and the function terminates.
                (b) If some species have fluctuating dynamics, 
        ...
        Returns
        -------
        proportion_fluctuating_reinvading_species : TYPE
            DESCRIPTION.
