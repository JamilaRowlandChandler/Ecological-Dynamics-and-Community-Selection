# -*- coding: utf-8 -*-
"""
Created on Wed Apr 30 15:31:15 2025
...
from simulation_functions import \
    consumer_resource_model_dynamics, CR_dynamics_df, prop_chaotic, distance_from_instability, \
...
def M_effect_fixed_mu_c(Ms, mu_c_range, sigma, n, fixed_parameters):
    
    subdirectory = 'finite_effects_fixed_mu_c'
    ...
    for parm_set in tqdm(parameters):
...
resource_pool_sizes = [100, 150, 200, 250]

M_effect_fixed_mu_c(resource_pool_sizes, np.array([0.667, 2]), 1.6/np.sqrt(150),
...
fig, axs = generic_heatmaps(df_mu_c_M,
                            'mu_c', 'no_resources',
                           'average consumption rate per resource, ' + r'$\mu_c$',
                           'resource pool size, ' + r'$M$',
                            ['Max. lyapunov exponent'], 'Purples',
                            'Communities destabilise with increasing resource pool size\n' + \
                            '(aka total consumption rate)',
                            (1, 1), (8.5, 3),
                            pivot_functions = {'Max. lyapunov exponent' : le_pivot},
                            specify_min_max={'Max. lyapunov exponent' : [0,1]})

axs.set_yticks([0.5, 1.5, 2.5, 3.5], labels = [100, 150, 200, 250], fontsize = 14)

cbar = axs.collections[0].colorbar
cbar.set_label(label = 'Proportion of simulations\nwith max. LE ' + r'$> 0.0025$',
               size = '14')
cbar.ax.tick_params(labelsize = 12)

plt.savefig("C:/Users/jamil/Documents/PhD/Data files and figures/Ecological-Dynamics-and-Community-Selection/Ecological Dynamics/Figures/self_limit_fixed_mu_c_M.png",
            bbox_inches='tight')
plt.savefig("C:/Users/jamil/Documents/PhD/Data files and figures/Ecological-Dynamics-and-Community-Selection/Ecological Dynamics/Figures/self_limit_fixed_mu_c_M.svg",
            bbox_inches='tight')
